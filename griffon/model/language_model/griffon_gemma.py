...
from griffon.mm_utils import KeywordsStoppingCriteria


class GriffonGemma2Config(Gemma2Config):
    model_type = "gemma2_Griffon"
...
class GriffonGemma2Model(GriffonMetaModel, Gemma2Model):
    config_class = GriffonGemma2Config

    def __init__(self, config: Gemma2Config):
        super(GriffonGemma2Model, self).__init__(config)


class GriffonGemma2ForCausalLM(Gemma2ForCausalLM, GriffonMetaForCausalLM):
    config_class = GriffonGemma2Config

    def __init__(self, config):
        super(Gemma2ForCausalLM, self).__init__(config)
        self.model = GriffonGemma2Model(config)
...
AutoConfig.register("gemma2_Griffon", GriffonGemma2Config)
AutoModelForCausalLM.register(GriffonGemma2Config, GriffonGemma2ForCausalLM)
